...
public class User implements Serializable {
    ...
    @BsonProperty("correo")
    @Null(message = "No se puede modificar el correo del usuario", groups = ValidationGroups.Put.class)
    ...
    @NotBlank(message = "El campo password no puede ser nulo o vacío")
    ...
    @BsonProperty("rol")
    @Null(message = "No se puede modificar el rol de usuario", groups = ValidationGroups.Put.class)
